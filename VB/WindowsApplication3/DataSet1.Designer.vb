...
Namespace DXSample
    ...
    Public Partial Class DataSet1
        ...
        Private tableCustomerInfo As DXSample.DataSet1.CustomerInfoDataTable
        ...
        Protected Sub New(ByVal info As Global.System.Runtime.Serialization.SerializationInfo, ByVal context As Global.System.Runtime.Serialization.StreamingContext)
            ...
            If(Me.DetermineSchemaSerializationMode(info, context) = Global.System.Data.SchemaSerializationMode.IncludeSchema) Then
                ...
                If(ds.Tables("CustomerInfo") IsNot Nothing) Then
                    MyBase.Tables.Add(New DXSample.DataSet1.CustomerInfoDataTable(ds.Tables("CustomerInfo")))
                End If
        ...
        Public Overrides Function Clone() As Global.System.Data.DataSet
            Dim cln As DXSample.DataSet1 = CType((MyBase.Clone()), DXSample.DataSet1)
            cln.InitVars()
        ...
        Friend Sub InitVars(ByVal initTable As Boolean)
            Me.tableCustomerInfo = CType((MyBase.Tables("CustomerInfo")), DXSample.DataSet1.CustomerInfoDataTable)
        ...
        Private Sub InitClass()
            ...
            Me.tableCustomerInfo = New DXSample.DataSet1.CustomerInfoDataTable()
        ...
        Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
            Dim ds As DXSample.DataSet1 = New DXSample.DataSet1()
        ...
        Public Delegate Sub CustomerInfoRowChangeEventHandler(ByVal sender As Object, ByVal e As DXSample.DataSet1.CustomerInfoRowChangeEvent)
        ...
        Public Partial Class CustomerInfoDataTable
            ...
            Default Public ReadOnly Property Item(ByVal index As Integer) As CustomerInfoRow
                Get
                    Return CType((Me.Rows(index)), DXSample.DataSet1.CustomerInfoRow)
                End Get
            End Property

            Public Event CustomerInfoRowChanging As DXSample.DataSet1.CustomerInfoRowChangeEventHandler

            Public Event CustomerInfoRowChanged As DXSample.DataSet1.CustomerInfoRowChangeEventHandler

            Public Event CustomerInfoRowDeleting As DXSample.DataSet1.CustomerInfoRowChangeEventHandler

            Public Event CustomerInfoRowDeleted As DXSample.DataSet1.CustomerInfoRowChangeEventHandler

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub AddCustomerInfoRow(ByVal row As DXSample.DataSet1.CustomerInfoRow)
                Me.Rows.Add(row)
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Function AddCustomerInfoRow(ByVal CustomerID As Integer, ByVal FirstName As String, ByVal LastName As String, ByVal Age As Integer) As CustomerInfoRow
                Dim rowCustomerInfoRow As DXSample.DataSet1.CustomerInfoRow = CType((Me.NewRow()), DXSample.DataSet1.CustomerInfoRow)
                Dim columnValuesArray As Object() = New Object() {CustomerID, FirstName, LastName, Age}
            ...
            Public Overrides Function Clone() As Global.System.Data.DataTable
                Dim cln As DXSample.DataSet1.CustomerInfoDataTable = CType((MyBase.Clone()), DXSample.DataSet1.CustomerInfoDataTable)
                cln.InitVars()
                Return cln
            End Function
            ...
            Protected Overrides Function CreateInstance() As Global.System.Data.DataTable
                Return New DXSample.DataSet1.CustomerInfoDataTable()
            End Function
            ...
            Public Function NewCustomerInfoRow() As CustomerInfoRow
                Return CType((Me.NewRow()), DXSample.DataSet1.CustomerInfoRow)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Function NewRowFromBuilder(ByVal builder As Global.System.Data.DataRowBuilder) As Global.System.Data.DataRow
                Return New DXSample.DataSet1.CustomerInfoRow(builder)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Function GetRowType() As Global.System.Type
                Return GetType(DXSample.DataSet1.CustomerInfoRow)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowChanged(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowChanged(e)
                RaiseEvent CustomerInfoRowChanged(Me, New DXSample.DataSet1.CustomerInfoRowChangeEvent(CType((e.Row), DXSample.DataSet1.CustomerInfoRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowChanging(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowChanging(e)
                RaiseEvent CustomerInfoRowChanging(Me, New DXSample.DataSet1.CustomerInfoRowChangeEvent(CType((e.Row), DXSample.DataSet1.CustomerInfoRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowDeleted(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowDeleted(e)
                RaiseEvent CustomerInfoRowDeleted(Me, New DXSample.DataSet1.CustomerInfoRowChangeEvent(CType((e.Row), DXSample.DataSet1.CustomerInfoRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Protected Overrides Sub OnRowDeleting(ByVal e As Global.System.Data.DataRowChangeEventArgs)
                MyBase.OnRowDeleting(e)
                RaiseEvent CustomerInfoRowDeleting(Me, New DXSample.DataSet1.CustomerInfoRowChangeEvent(CType((e.Row), DXSample.DataSet1.CustomerInfoRow), e.Action))
            End Sub

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub RemoveCustomerInfoRow(ByVal row As DXSample.DataSet1.CustomerInfoRow)
                Me.Rows.Remove(row)
            End Sub
        ...
        Public Partial Class CustomerInfoRow
            ...
            Friend Sub New(ByVal rb As Global.System.Data.DataRowBuilder)
                MyBase.New(rb)
                Me.tableCustomerInfo = CType((Me.Table), DXSample.DataSet1.CustomerInfoDataTable)
            End Sub
            ...
            Public Property Age As Integer
                Get
                    Try
                        Return(CInt((Me(Me.tableCustomerInfo.AgeColumn))))
                    Catch e As Global.System.InvalidCastException
                        Throw New Global.System.Data.StrongTypingException("The value for column 'Age' in table 'CustomerInfo' is DBNull.", e)
                    End Try
                End Get

                Set(ByVal value As Integer)
                    Me(Me.tableCustomerInfo.AgeColumn) = value
                End Set
            End Property
            ...
            Public Function IsAgeNull() As Boolean
                Return Me.IsNull(Me.tableCustomerInfo.AgeColumn)
            End Function

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub SetAgeNull()
                Me(Me.tableCustomerInfo.AgeColumn) = Global.System.Convert.DBNull
            End Sub
        End Class
        ...
        Public Class CustomerInfoRowChangeEvent
            ...
            Private eventRow As DXSample.DataSet1.CustomerInfoRow

            Private eventAction As Global.System.Data.DataRowAction

            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>
            Public Sub New(ByVal row As DXSample.DataSet1.CustomerInfoRow, ByVal action As Global.System.Data.DataRowAction)
                Me.eventRow = row
